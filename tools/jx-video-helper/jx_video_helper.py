...
class App(tk.Tk):
    ...
    def _build(self):
        ...
        ttk.Label(runbar, text="备份、转码、上传进行中可点停止；进行中会阻止电脑自动休眠。关窗口也会先停任务。").pack(side="left", padx=8)
